...
path = input("Enter your path to a file: ")
file = "data"

created = create_file(path, file)

write_file(created, chess_players)

for x in read_file(created):
    pp(x)
print(len(read_file(created)))
...
# update_file(created, new_players)
